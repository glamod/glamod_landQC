...
def _setup_gaussian_station() -> utils.Station:
    """Create a station with random gaussianly distributed
    temperatures for 10 Januaries
...
@pytest.mark.parametrize("bad_value, expected", ([400, []],
                                                 [1200, []],
                                                 [1201, [3]]))
def test_scan_histogram_slope(bad_value: int,
                              expected: list) -> None:
    """Test that peaks are pulled out as expected"""
...
def test_identify_values_gaussian() -> None:
    ...
    station = _setup_gaussian_station()
...
def test_frequent_values() -> None:
    """Test overall script with example data"""
...
def test_fvc(identify_mock: Mock,
    ...
    """Test control script calls routines as expected"""
